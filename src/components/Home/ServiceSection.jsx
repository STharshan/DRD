...
const services = [
  {
    ...
    desc: `Optimizing an engine's software to significantly increase its horsepower, torque, and overall responsiveness.`,
    image: "/carpaint.avif",
    path: "/services/mechanical",
  },
  {
    title: "DPF Removal",
    desc:  `Removing the Diesel Particulate Filter from a vehicle's exhaust system
​`,
    image: "/gray.avif",
  ...
  {
    title: "Van Tuning",
    desc: ` Adjusts commercial vehicle software for improved fuel efficiency and enhanced low-end torque.`,
